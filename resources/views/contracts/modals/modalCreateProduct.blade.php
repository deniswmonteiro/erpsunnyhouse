<div class="modal fade w-100 text-black" id="modal-create-product"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg"
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Insira os dados do Produto</h5>
                ...
                <form action="#" method="POST"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" id="create-equipment-id"
                                name="create-equipment-id"
                                value="">
                                ...
                                <div class="col-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" aria-label="create-equipment-type"
                                            ...
                                            onchange="return window.validateSelect(this), window.handleEquipmentType(this)"
                                            required>
