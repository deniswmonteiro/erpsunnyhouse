@section('page_title', 'Contratos - Instalação')

<script src="{{asset(mix('js/contracts/list.js'))}}" defer></script>
<script src="{{asset(mix('js/contracts/list-installation.js'))}}" defer></script>
<script>
    ...
    <x-slot name="header">
        <div class="row">
            <div class="col-12 order-md-1 order-last">
                <h3>Contratos de Instalação Registrados no Sistema</h3>
            </div>
        </div>
    </x-slot>

    <div id="contract-list-installation">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-12 col-lg-10">
                        <h4 class="card-title">Gerenciar Contratos de Instalação</h4>
                        <p class="card-description">
                            Por meio desta tela é possível realizar o gerenciamento dos contratos de instalação registrados no sistema.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row mb-5">
                    <div class="col-12 col-md-4 col-lg-3">
                        <a href="{{route('contracts_create', ['type' => 'installation'])}}"
                        ...
                        <table class="table table-striped pt-4" id="contract-table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="text-center">Potência do Gerador (kWp)</th>
                                    <th scope="col" class="text-center">Valor</th>
                                    <th scope="col" class="text-center">Opções</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($contracts_installation as $key => $contract)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <!-- Contract edit -->
                                                <form action="{{route('contracts_edit', ['type' => 'installation', 'id' => encrypt($contract->id)])}}" method="GET"
                                        ...
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" aria-label="status-edit"
                                                        id="status-edit-{{$key}}"
                                                        name="status"
