@section('page_title', 'Contratos Relacionados com o(a) Vendedor')

<script src="{{asset(mix('js/sellers/listSellerContracts.js'))}}" defer></script>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="card-description">
                            Os seguintes contratos possuem relação com o(a) vendedor(a)
