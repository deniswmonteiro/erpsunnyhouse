...
<x-app-layout>
    <x-slot name="header">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Edite os dados do vendedor selecionado.</p>
            </div>
        </div>
    </x-slot>
    ...
    <div>
        <form action="{{route('sellers_update',['id' => encrypt($seller->id)])}}" method="post"
              onsubmit="return window.submit_form_seller_update()">
            @csrf
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="name" type="text" value="{{($seller->name)}}" name="name"
                               class="form-control">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="phone" type="text" value="{{$seller->phone}}" name="phone"
                               class="form-control">
                        <div class="invalid-feedback">
                            Formato incorreto.
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12 col-md-12 col-lg-2">
                            ...
                            <input type="text" name="cep" id="cep" value="{{$seller->cep}}"
                                   class="form-control">
                        </div>
                        ...
                        <div class="form-group col-12 col-md-12 col-lg-8">
                            ...
                            <input type="text" name="address" id="address" value="{{($seller->address)}}"
                                   class="form-control">
                        </div>
                        ...
                        <div class="form-group col-12 col-md-12 col-lg-2">
                            ...
                            <input type="text" name="number" id="address"
                        ...
                        <div class="row">
                            <div class="col-2 offset-10">
                                <button class="btn bg-orange float-end mt-2" type="submit"
                                        onsubmit="return window.submit_form_seller_update()">Atualizar</button>
                            </div>
