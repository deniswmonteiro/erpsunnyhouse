<x-print-layout>
    ...
    <div class="page position-relative" id="request-second-1">
        <div class="border border-2 border-bottom-0 border-dark" style="padding: 2px 8px !important">
            <div class="row border border-2 border-dark p-1 mb-2">
                    ...
                    <tfoot class="border-top-0">
                        <tr>
                            ...
                            <td scope="row" class="text-center fw-bold p-1">
                                {{number_format($aboveseventyfive_solar_qty_sum, 0, ',', '.')}}
                            </td>
                            <td scope="row" class="text-center fw-bold p-1">
                                {{number_format($aboveseventyfive_solar_peakpower_sum, 2, ',', '.')}}
                            </td>
                            <td scope="row" class="text-center fw-bold p-1">
                                {{number_format($aboveseventyfive_solar_arrangementarea_sum, 2, ',', '.')}}
                            </td>
                            <td scope="row" class="p-1" style="background-color: #808080"></td>
                            <td scope="row" class="p-1" style="background-color: #808080"></td>
                        </tr>
    ...
    <div class="page position-relative" id="request-second-2">
        <div class="border border-2 border-top-0 border-bottom-0 border-dark" style="padding: 2px 8px !important">
            <div class="row mb-3">
                <!-- Inverters Data -->
                <table class="table table-bordered mb-0">
                    <tbody class="border-top-0">
                            ...
                            @if ($key == 'inverter')
                                @for ($i = 16; $i <= 50; $i++)
                                    <tr>
                                        ...
                                        <td class="text-center p-1" style="background-color: #FFE7D6"></td>
                                        <td class="text-center p-1" style="background-color: #FFE7D6"></td>
                                        <td class="text-center p-1" style="background-color: #FFE7D6; width: 60px"></td>
                                        <td class="text-center p-1" style="background-color: #FFE7D6; width: 90px"></td>
                                        <td class="text-center p-1" style="background-color: #FFE7D6; width: 75px"></td>
                                        <td class="text-center p-1" style="background-color: #FFE7D6; width: 75px"></td>
                                        <td class="text-center p-1" style="background-color: #FFE7D6; width: 75px"></td>
                                        <td class="text-center p-1" style="background-color: #FFE7D6; width: 90px"></td>
                                    </tr>
                    ...
                    <tfoot class="border-top-0">
                        <tr>
                            ...
                            <td scope="row" class="p-1" style="background-color: #808080"></td>
                            <td scope="row" class="text-center fw-bold p-1">
                                {{number_format($aboveseventyfive_inverter_ratedpower_sum, 2, ',', '.')}}
                            </td>
                            <td scope="row" class="p-1" style="background-color: #808080"></td>
                            <td scope="row" class="p-1" style="background-color: #808080"></td>
                            <td scope="row" class="p-1" style="background-color: #808080"></td>
                ...
                <table class="table table-bordered mb-1">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center p-1" style="background-color: #D8D8D8; width: 80px !important">
                                Rio
                            </th>
                            <th class="text-center p-1" style="background-color: #D8D8D8">
                                Bacia / SubBacia
    ...
    <div class="page position-relative" id="request-second-3">
        <div class="border border-2 border-top-0 border-dark" style="padding: 2px 8px !important">
            <!-- Hydraulics -->
            <div class="row mb-3">
                <table class="table table-bordered mb-1">
                    <tbody class="border-top-0">
                        @for ($i = 6; $i <= 10; $i++)
                            <tr>
                                <th scope="row" class="text-center align-middle p-1"
                                    style="width: 29.8937px !important">
                                    {{$i}}
                                </th>
                                <td class="text-center p-1"
                                    style="background-color: #FFE7D6; width: 80px !important"></td>
                                <td class="text-center p-1"
                                    style="background-color: #FFE7D6; width: 66.8875px !important"></td>
                                <td class="text-center p-1"
                                    style="background-color: #FFE7D6; width: 49.5687px !important"></td>
                                <td class="text-center p-1" 
                                    style="background-color: #FFE7D6; width: 73.975px  !important"></td>
                                <td class="text-center p-1" 
                                    style="background-color: #FFE7D6; width: 88.0875px !important"></td>
                                <td class="text-center p-1" 
                                    style="background-color: #FFE7D6; width: 75.2312px !important"></td>
                                <td class="text-center p-1" 
                                    style="background-color: #FFE7D6; width: 99.6875px !important"></td>
                                <td class="text-center p-1" 
                                    style="background-color: #FFE7D6; width: 107.856px !important"></td>
                                <td class="text-center p-1" 
                                    style="background-color: #FFE7D6; width: 97.25px !important"></td>
                            </tr>
                        @endfor
                    </tbody>
                    <tfoot class="border-top-0">
        ...
        <div class="border border-2 border-bottom-0 border-dark p-1" style="padding: 2px 8px !important">
            <div class="row border border-2 border-dark">
                ...
                <div class="col-10 text-center pt-3 pb-3">
                    ...
                    <h2 class="d-block fw-bold text-black mb-0" style="font-size: 10px !important">
                        ANEXO I - Formulário de Solicitação de Acesso para Minigeração Distribuída
                        <span class="d-block" style="font-size: 8px !important">
                            (acima de 75 kW até 5000 kW qualquer tipo de fonte renovável e cogeração qualificada)
                        </span>
                    </h2>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-3 mb-3">
                    <div class="form-group border border-dark mb-0 p-0">
                        <div class="bg-gray border-bottom border-dark text-center p-1">
                            <span>CPF/CNPJ</span>
                        </div>
                ...
                <div class="col-7 ps-0 mb-3">
                    <div class="form-group text-center border border-dark p-1 mb-0">
                        <span class="text-uppercase fw-bold">
                            Informar a conta contrato e apresentar documentos conforme CAMPO 5
                        </span>
                    </div>
                </div>
                ...
                <div class="col-4 mb-3">
                    <div class="row">
                        ...
                        <div class="col-3 ps-0">
                            <div class="form-group text-center border border-dark p-1 mb-0">
                                <p class="mb-0">
                                    @if ($document_request->average_fp != null)
                                        <span>
                                            {{$document_request->average_fp}}
                                        </span>
                                    @else
                                        &ndash;
                                    @endif
                            ...
                            <div class="row">
                                <div class="col-6 ps-0 pe-0">
                                    <div class="form-group text-center border border-end-0 border-dark p-1 mb-0">
                                        <p class="mb-0">
                                            @if ($document_request->uc_installed_load_kw != null)
                                                <span class="fw-bold">
                                                    {{Str::of($document_request->uc_installed_load_kw / 1000)
                                                        ->replace('.', ',')}} kW
                                                </span>
                                            @else
                                                &ndash;
                                ...
                                <div class="col-6 ps-0">
                                    <div class="form-group text-center border border-dark p-1 mb-0">
                                        <p class="mb-0">
                                            @if ($document_request->uc_installed_load_kva != null)
                                                <span class="fw-bold">
                                                    {{Str::of($document_request->uc_installed_load_kva / 1000)
                                                        ->replace('.', ',')}} kVA
                                                </span>
                                            @else
                                                &ndash;
                        ...
                        <div class="col-7 pe-0">
                            <div class="row">
                                <div class="col-6 ps-0 pe-0">
                                    <div class="form-group text-center border border-end-0 border-dark p-1 mb-0">
                                        <p class="mb-0">
                                            @if ($document_request->uc_demand_kw != null)
                                                <span class="fw-bold">
                                                    {{Str::of($document_request->uc_demand_kw / 1000)
                                                        ->replace('.', ',')}} kW
                                                </span>
                                            @else
                                                &ndash;
                                ...
                                <div class="col-6 ps-0">
                                    <div class="form-group text-center border border-dark p-1 mb-0">
                                        <p class="mb-0">
                                            @if ($document_request->uc_demand_kva != null)
                                                <span class="fw-bold">
                                                    {{Str::of($document_request->uc_demand_kva / 1000)
                                                        ->replace('.', ',')}} kVA
                                                </span>
                                            @else
                                                &ndash;
                ...
                <div class="col-5 mb-3">
                    <div class="row">
                        <div class="col-7 ps-0 pe-0">
                            <div class="form-group bg-gray border border-end-0 border-dark p-1 mb-0">
                                <p class="mb-0">
                                    Padrão de Entrada da UC (<span class="text-danger">selecionar</span>)
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-5 ps-0">
                            <div class="form-group text-center border border-dark p-1 mb-0">
                                <p class="fw-bold text-uppercase mb-0">
                                    {{$document_request->uc_input_pattern}}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-3 mb-3">
                    <div class="row">
                        <div class="col-8 pe-0">
                            <div class="form-group bg-gray border border-end-0 border-dark p-1 mb-0">
                                <p class="mb-0">
                                    Conexão da UC (<span class="text-danger">selecionar</span>)
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-4 mb-3">
                    <div class="row">
                        <div class="col-9 pe-0">
                            <div class="form-group bg-gray border border-end-0 border-dark p-1 mb-0">
                                <p class="mb-0">
                                    Tensão de Atendimento da UC (<span class="text-danger">selecionar</span>)
                                </p>
                            </div>
                        </div>
                        <div class="col-3 ps-0 pe-0">
                            <div class="form-group text-center border border-dark p-1 mb-0">
                                <p class="mb-0">
                                    @if ($document_request->uc_power != null)
                                        <span class="fw-bold">
                                            {{Str::of($document_request->uc_power / 1000)->replace('.', ',')}} kV
                                        </span>
                                    @else
                                        &ndash;
                                    @endif
                ...
                <div class="col-3 mb-3">
                    <div class="row">
                        <div class="col-7 ps-0 pe-0">
                            <div class="form-group bg-gray border border-end-0 border-dark p-1 mb-0">
                                <p class="mb-0">
                                    Tarifa GRUPO A (<span class="text-danger">selecionar</span>)
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-7 ps-0 pe-0">
                            <div class="row">
                                <div class="col-2 pe-0">
                                    <div class="form-group border border-end-0 border-dark p-1 mb-0">
                                        <span>FP: </span>
                                    </div>
                                </div>
                                <div class="col-4 ps-0 pe-0">
                                    <div class="form-group text-center border border-start-0 border-end-0 border-dark p-1 ps-0 mb-0">
                                        <p class="mb-0">
                                            @if ($document_request->point_coordinate_y != null)
                                                <span class="fw-bold">
                                                    {{Str::of($document_request->contracted_demand_fp / 1000)
                                                        ->replace('.', ',')}} kW
                                                </span>
                                            @else
                                                &ndash;
                                ...
                                <div class="col-4 ps-0">
                                    <div class="form-group text-center border border-start-0 border-dark p-1 mb-0">
                                        <p class="mb-0">
                                            @if ($document_request->point_coordinate_x != null)
                                                <span class="fw-bold">
                                                    {{Str::of($document_request->contracted_demand_p / 1000)
                                                        ->replace('.', ',')}} kW
                                                </span>
                                            @else
                                                &ndash;
                ...
                <div class="col-12 mb-3">
                    <div class="row">
                        <div class="col-8 ps-0 pe-0">
                            <div class="form-group bg-gray border border-end-0 border-dark p-1 mb-0">
                                <span>
                                    Nº de dentificação do poste ou transformador mais próximo do ponto de entrega/conexão da Unidade Consumidora
                                </span>
                            </div>
                        </div>
                        <div class="col-4 ps-0 pe-0">
            ...
            <div class="row">
                ...
                <div class="col-3 mb-3 pe-0">
                    <div class="form-group border border-dark mb-0 p-0">
                        ...
                        <div class="p-1" style="min-height: 13.1855px"></div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-2 mb-3 pe-0">
                    <div class="form-group border border-1 border-dark mb-0 p-0 mb-0">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-8 ps-0">
                                        <div class="form-group text-center border-bottom border-bottom border-dark ps-1 p-1 mb-0">
                                            <p class="mb-0">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-8 ps-0">
                                        <div class="form-group text-center border-bottom border-dark ps-1 p-1 mb-0">
                                            <p class="mb-0">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-8 ps-0">
                                        <div class="form-group text-center ps-1 p-1 mb-0">
                                            <p class="mb-0">
                                                &ndash;
                                            </p>
                                        </div>
            ...
            <!-- Data on the Substation Transformers for Connection with the Distribution System -->
             <div class="row border border-2 border-dark p-1 mb-3 mt-1">
                <p class="fw-bold mb-0 p-0" style="font-size: 8px !important">
                    3. Dados dos Transformadores da Subestação de Conexão com o Sistema de Distribuição
                </p>
            </div>
                ...
                <table class="table table-bordered mb-1">
                            ...
                            @if ($key == 'transformer')
                                @foreach ($data as $key => $solar_item)
                                    <tr>
                                        ...
                                        <td class="text-center p-1">
                                            {{$solar_item['rated-power']}}
                                        </td>
                                        <td class="text-center p-1">
                                            @if ($solar_item['rated-power'] != '' || $solar_item['impedance'] != '' || $solar_item['primary-voltage'] != '' || $solar_item['secondary-voltage'] != '' || $solar_item['switch-range'] != '')
                                                &Delta;-Y
                                            @endif
                                        </td>
                                        <td class="text-center p-1">
                                            {{$solar_item['impedance']}}
                                        </td>
                                        <td class="text-center p-1">
                                            {{$solar_item['primary-voltage']}}
                                        </td>
                                        <td class="text-center p-1">
                                            {{$solar_item['secondary-voltage']}}
                                        </td>
                                        <td class="text-center p-1">
                                            {{$solar_item['switch-range']}}
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <tfoot class="border-top-0">
                        <tr>
                            ...
                            <td scope="row" class="text-center fw-bold p-1">
                                @if ($aboveseventyfive_transformer_ratedpower_sum != 0)
                                    {{number_format($aboveseventyfive_transformer_ratedpower_sum, 0, ',', '.')}}
                                @endif
                            </td>

                            @for ($i = count($data) + 1; $i <= 6; $i++)
                                <td scope="row" class="p-1" style="background-color: #808080"></td>
                            @endfor
                        </tr>
                    </tfoot>
            ...
            <div class="row border border-2 border-dark p-1 mt-3">
                <p class="fw-bold mb-0 p-0" style="font-size: 8px !important">
                    4. Características da Microgeração Distribuída
                </p>
            </div>

            <div class="row">
                <p class="fw-bold">Dados gerais da Central Geradora</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-4 mb-3 pe-0">
                    <div class="form-group border border-dark mb-0" style="min-height: 15.1855px">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-4 mb-3">
                    <div class="row">
                        <div class="col-7 ps-0 pe-0">
                            <div class="form-group bg-gray border border-end-0 border-dark p-1 mb-0">
                                <span>Potência Disponibilizada (PD)</span>
                            </div>
                        </div>
                        <div class="col-5 ps-0">
                            <div class="row">
                                <div class="col-7 pe-0">
                                    <div class="form-group text-center border border-end-0 border-dark p-1 mb-0" style="background-color: #00B242">
                                        <p class="fw-bold mb-0">
                                            @if ($document_request->generation_available_power != null)
                                                {{Str::of($document_request->generation_available_power / 1000)
                                                    ->replace('.', ',')}}
                                            @else
                                                &ndash;
                                            @endif
    ...
    <div class="page position-relative" id="request-second-5">
        <div class="border border-2 border-top-0 border-dark p-1" style="padding: 2px 8px !important">
            <!-- Necessary Documents -->
            <div class="row border border-2 border-dark p-1 mb-3 mt-1">
                <p class="fw-bold mb-0 p-0" style="font-size: 8px !important">
                    5. Documentos necessários que devem ser anexados à Solicitação de Acesso:
                </p>
            </div>
            ...
            <div class="row">
                <table class="table table-borderless mb-2">
                    <thead class="border border-dark">
                        <tr>
                            <th scope="col" class="border-end border-dark text-center p-1">Descrição</th>
                            <th scope="col" class="text-center p-1" style="width: 240px">Observações</th>
                        </tr>
                    </thead>
                    <tbody class="border border-1 border-dark">
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                5. Estágio atual do empreendimento, cronograma de implantação e expansão (PLANILHA NA GUIA 3)
                            </td>
                            <td class="border-bottom border-dark p-1">
                                {{$document_request->current_stage_observation}}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                6. Certificados de Conformidade dos Inversores ou o número de registro de concessão do INMETRO do(s) inversor(es) para a tensão nominal de conexão com a rede
                            </td>
                            <td class="border-bottom border-dark p-1">
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                7. Lista de unidades consumidoras participantes do sistema de compensação (se houver) indicando na porcentagem de rateio dos créditos e o enquadramento conforme incisos VI a VIII do art. 2º da Resolução Normativa nº 482/2012 (PLANILHA NA GUIA 2)
                            </td>
                            <td class="border-bottom border-dark p-1">
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                10. Formulário de Viabilidade Técnica, conforme ANEXO III - SOLICITAÇÃO DE VIABILIDADE TÉCNICA da norma NT.002.EQTL.Normas e Padrões
                            </td>
                            <td class="border-bottom border-dark p-1">
                                {{$document_request->technical_viability_observation}}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                11. Quadro de Cargas para Cálculo Preliminar da Carga Instalada e da Demanda e Cálculo de Parâmetros Preliminares de Dimensionamento para
                                Subestação Aérea até 300 kVA, conforme ANEXO II - DIMENSIONAMENTO DE SE AÉREA da norma NT.002.EQTL.Normas e Padrões
                            </td>
                            <td class="border-bottom border-dark p-1">
                                {{$document_request->air_substation_observation}}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                12. Quadro de Cargas para Cálculo Preliminar da Carga Instalada e da Demanda para Subestação Abrigada (alvernaria ou cubículo) acima de 300
                                kVA, conforme ANEXO I - CÁLCULO DA DEMANDA da norma NT.002.EQTL.Normas e Padrões
                            </td>
                            <td class="border-bottom border-dark p-1">
                                {{$document_request->air_sheltered_observation}}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                13. Contrato de Aluguel ou Arrendamento da unidade consumidora (quando necessário, conforme observação)
                            </td>
                            <td class="border-bottom border-dark p-1">
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                14. Procuração (quando necesário, conforme observação)
                            </td>
                            <td class="border-bottom border-dark p-1">
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                15. Autorização de uso de área comum em condomínio (quando necessário, conforme observação)
                            </td>
                            <td class="border-bottom border-dark p-1">
        ...
        <span class="d-block">
            GERÊNCIA CORPORATIVA DE NORMAS E PADRÕES. NT.021.EQTL.Normas e Padrões ANEXO I - FORMULÁRIO DE SOLICITAÇÃO DE ACESSO PARA MINIGERAÇÃO DISTRIBUÍDA REVISÃO 02. DATA: 06/09/2019
        </span>
        <span class="d-block">
            ELABORADO POR: GILBERTO CARRERA
        </span>
    </div>
</x-print-layout>