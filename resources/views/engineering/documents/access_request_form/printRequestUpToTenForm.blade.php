<x-print-layout>
    ...
    <div class="page position-relative" id="request-first-1">
        <div class="border border-2 border-dark mb-2" style="padding: 2px 8px !important">
            <div class="row border border-2 border-dark p-1">
                    ...
                    <tfoot class="border-top-0">
                        <tr>
                            ...
                            <td scope="row" class="text-center fw-bold p-1">
                                {{number_format($uptoten_solar_qty_sum, 0, ',', '.')}}
                            </td>
                            <td scope="row" class="text-center fw-bold p-1">
                                {{number_format($uptoten_solar_peakpower_sum, 2, ',', '.')}}
                            </td>
                            <td scope="row" class="text-center fw-bold p-1">
                                {{number_format($uptoten_solar_arrangementarea_sum, 2, ',', '.')}}
                            </td>
                            <td scope="row" class="p-1" style="background-color: #808080"></td>
                            <td scope="row" class="p-1" style="background-color: #808080"></td>
                        </tr>
                ...
                <table class="table table-bordered mb-0">
                    ...
                    <tfoot class="border-top-0">
                        <tr>
                            ...
                            <td scope="row" class="p-1" style="background-color: #808080"></td>
                            <td scope="row" class="text-center fw-bold p-1">
                                {{number_format($uptoten_inverter_ratedpower_sum, 2, ',', '.')}}
                            </td>
                            <td scope="row" class="p-1" style="background-color: #808080"></td>
                            <td scope="row" class="p-1" style="background-color: #808080"></td>
                            <td scope="row" class="p-1" style="background-color: #808080"></td>
    ...
    <div class="page position-relative" id="request-first-2">
        <div class="border border-2 border-bottom-0 border-dark p-1" style="padding: 2px 8px !important">
            <div class="row border border-2 border-dark">
                ...
                <div class="col-10 text-center pt-3 pb-3">
                    ...
                    <h2 class="d-block fw-bold text-black mb-0" style="font-size: 10px !important">
                        ANEXO I - Formulário de Solicitação de Acesso para Microgeração Distribuída até 10 kW
                    </h2>
                </div>
            </div>
                            ...
                            <div class="form-group text-center border border-dark p-1 mb-0">
                                <p class="mb-0">
                                    @if ($document_request->uc_declared_load != null)
                                        <span class="fw-bold">
                                            {{Str::of($document_request->uc_declared_load / 1000)->replace('.', ',')}} kW
                                        </span>
                                    @else
                                        &ndash;
                                    @endif
                            ...
                            <div class="form-group text-center border border-dark p-1 mb-0">
                                <p class="mb-0">
                                    @if ($document_request->uc_circuit_breaker != null)
                                        <span class="fw-bold">
                                            {{Str::of($document_request->uc_circuit_breaker)->replace('.', ',')}} A
                                        </span>
                                    @else
                                        &ndash;
                                    @endif
                            ...
                            <div class="form-group text-center border border-dark p-1 mb-0">
                                <p class="mb-0">
                                    @if ($document_request->uc_available_power != null)
                                        <span class="fw-bold">
                                            {{Str::of($document_request->uc_available_power / 1000)->replace('.', ',')}} kW
                                        </span>
                                    @else
                                        &ndash;
                                    @endif
            ...
            <div class="row">
                ...
                <div class="col-6 mb-3 ps-0">
                    <div class="form-group border border-dark mb-0 p-0">
                        ...
                        <div class="p-1">
                            <p class="mb-0">
                                @if ($document_request->responsible_name != null)
                                    {{$document_request->responsible_name}}
                                @else
                                    &ndash;
                                @endif
                            </p>
                ...
                <div class="col-3 mb-3">
                    <div class="form-group border border-dark mb-0 p-0">
                        <div class="text-center bg-gray border-bottom border-dark p-1">
                            <span>Telefone do Responsável Legal</span>
                        </div>
                        <div class="text-center p-1">
                            <p class="mb-0">
                                @if ($document_request->responsible_phone != null)
                                    {{$document_request->responsible_phone}}
                                @else
                                    &ndash;
                                @endif
                            </p>
                ...
                <div class="col-3 mb-3 pe-0">
                    <div class="form-group border border-dark mb-0 p-0">
                        <div class="text-center bg-gray border-bottom border-dark p-1">
                            <span>Email do Responsável Legal</span>
                        </div>
                        <div class="text-center p-1">
                            <p class="mb-0">
                                @if ($document_request->responsible_email != null)
                                    {{$document_request->responsible_email}}
                                @else
                                    &ndash;
                                @endif
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-4 mb-3 pe-0">
                    <div class="form-group border border-1 border-dark mb-0 p-0">
                        <div class="text-center bg-gray border-bottom border-dark p-1">
            ...
            <div class="row">
                <table class="table table-borderless mb-3">
                    ...
                    <tbody class="border border-1 border-dark">
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                4. Certificados de Conformidade dos Inversores ou o número de registro de concessão do INMETRO do(s) inversor(es) para a tensão nominal de conexão com a rede
                            </td>
                            <td class="border-bottom border-dark p-1">
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                5. Lista de unidades consumidoras participantes do sistema de compensação (se houver) indicando na porcentagem de rateio dos créditos e o enquadramento conforme incisos VI a VIII do art. 2º da Resolução Normativa nº 482/2012 (PLANILHA NA GUIA 2)
                            </td>
                            <td class="border-bottom border-dark p-1">
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                8. Formulário de Ligação Nova (quando necessário, conforme observação) (Conforme ANEXO IV - FORMULÁRIO DE LIGAÇÃO NOVA)
                            </td>
                            <td class="border-bottom border-dark p-1">
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                9. Formulário de Troca de Padrão (de monofásico para bifásico ou trifásico, de bifásico para trifásico, de trifásico para bifásico ou monofásico, de bifásico para monofásico) (Conforme ANEXO V - FORMULÁRIO DE TROCA DE PADRÃO)
                            </td>
                            <td class="border-bottom border-dark p-1">
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                10. Contrato de Aluguel ou Arrendamento da unidade consumidora (quando necessário, conforme observação)
                            </td>
                            <td class="border-bottom border-dark p-1">
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                11. Procuração (quando necesário, conforme observação)
                            </td>
                            <td class="border-bottom border-dark p-1">
                        ...
                        <tr>
                            <td class="border-end border-bottom border-dark p-1">
                                12. Autorização de uso de área comum em condomínio (quando necessário, conforme observação)
                            </td>
                            <td class="border-bottom border-dark p-1">
    ...
    <div class="page position-relative" id="request-first-3">
            ...
            <div class="row border border-2 border-top-0 border-dark">
                <div class="col-7 border-end border-dark ps-0">
                    <div class="form-group p-1 mb-0">
                        <p class="mb-0">
                            Em caso de dúvidas entre em contato através dos seguintes canais de atendimento ou nos locais onde há Consultores do Atendimento Corporativo:
                        </p>
                        ...
                        <ul>
                            ...
                            <li>
                                Telefone: 0800 280 3216
                            </li>
                            <li>
                                E-mail - <a href="mailto:grandesclientes.para@equatorialenergia.com.br" class="fw-bold" style="color: #00B2F5">grandesclientes.para@equatorialenergia.com.br</a>
                            </li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                Telefone: 0800 280 2800
                            </li>
                            <li>
                                E-mail - <a href="mailto:grandesclientes.maranhao@equatorialenergia.com.br" class="fw-bold" style="color: #00B2F5">grandesclientes.maranhao@equatorialenergia.com.br</a>
                            </li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                Telefone: 0800 086 8500
                            </li>
                            <li>
                                E-mail - <a href="mailto:grandesclientes.piaui@equatorialenergia.com.br" class="fw-bold" style="color: #00B2F5">grandesclientes.piaui@equatorialenergia.com.br</a>
                            </li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                Telefone: 0800 082 8500
                            </li>
                            <li>
                                E-mail - <a href="mailto:grandesclientes.alagoas@equatorialenergia.com.br" class="fw-bold" style="color: #00B2F5">grandesclientes.alagoas@equatorialenergia.com.br</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-5 ps-0 pe-0">
                    <div class="form-group p-1 mb-0">
                        <span class="mb-1">
                            Eu, acessante identificado neste formulário ou procurador legal, venho por meio deste instrumento, solicitar o acesso para microgeração distribuída, fornecendo meus dados cadastrais assim como as documentos necessários, em conformidade com as normas e resoluções aplicáveis.
                        </span>
        ...
        <div class="row mt-1">
            <span class="d-block">
                GERÊNCIA CORPORATIVA DE NORMAS E PADRÕES. NT.020.EQTL.Normas e Padrões ANEXO I - FORMULÁRIO DE SOLICITAÇÃO DE ACESSO PARA MICROGERAÇÃO DISTRIBUÍDA ATÉ 10 kW REVISÃO 02.
            </span>
            <span class="d-block">
