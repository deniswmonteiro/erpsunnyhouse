@section('page_title', 'Adicionar Contratos')

<script src="{{asset(mix('js/sunnypark/contratos/create.js'))}}" defer></script>
<script>
...
<x-app-layout>
    <x-slot name="header">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Insira no formulário os dados do novo contrato.</p>
            </div>
        </div>
    </x-slot>
    ...
    {{-- View --}}
    <div>
    	<form id="form-create-contract" action="{{route('sunnypark_contratos_store')}}" method="post">
            @csrf
            ...
            <div class="card">
                ...
                <div class="card-body">
                	<div class="row">
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <select class="form-select" aria-label="type" id="type" name="type"
                                    ...
                                    <option value="flex_plus">Flex Plus</option>
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            <div class="form-group">
                                <label for="contract-vigencia" class="form-label">Tempo de Vigência (mês)</label>
                                <div class="input-group">
                                    <input id="contract-vigencia" type="number" value="" 
                        ...
                        <div class="col-12 col-md-4 mb-3" style="display: none;">
                            <div class="form-group">
                                <label for="contract-date" class="form-label">Inicio de Vigência</label>
                                <div class="input-group">
                                    <input id="contract-date" type="date" value="" 
                                        name="contract-date"
                                        class="form-control date"
                                        {{-- required --}}>
                                    <div class="invalid-feedback"></div>
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <input id="desconto" type="text" name="desconto" class="form-control" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <input id="tarifa_base" type="text" name="tarifa_base" class="form-control" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <input id="meta_gestao" type="text" name="meta_gestao" class="form-control" value="" required>
                            </div>
                        </div>
                    </div>
