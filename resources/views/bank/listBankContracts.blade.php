@section('page_title', 'Contratos Relacionados com o Banco')

<script src="{{asset(mix('js/bank/listBankContracts.js'))}}" defer></script>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="card-description">
                            Os seguintes contratos estão relacionados com o banco <span class="fw-bold text-primary">{{$bank->name}}</span>
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <span class="d-block">
                                        Você deseja excluir este contrato da nossa base de dados?
                                    </span>
