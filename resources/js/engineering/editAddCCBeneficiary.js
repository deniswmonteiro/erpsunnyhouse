window.editAddCCBeneficiary = function (el) {
            ...
            <div class="accordion-item" 
                ...
                <h2 class="accordion-header d-flex" 
                    ...
                    <button type="button" class="accordion-button fw-bold rounded-0 rounded-start bg-light bg-gradient text-primary" 
                        ...
                        data-bs-target="#beneficiary-collapse-${generator.toString()}-${beneficiary.toString()}" aria-expanded="true"
                ...
                <div id="beneficiary-collapse-${generator.toString()}-${beneficiary.toString()}"
                    ...
                    <div class="accordion-body">
                        <div class="d-none"
                            id="beneficiary-client-${generator.toString()}-${beneficiary.toString()}">
                            <div class="row mt-3">
                                <div class="col-12 mb-4">
                                    <div class="form-check">
                                        ...
                                        <label for="chk-add-beneficiary-client-${generator.toString()}-${beneficiary.toString()}" class="form-check-label">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" 
                                        aria-label="project-beneficiary-consumption-class"
