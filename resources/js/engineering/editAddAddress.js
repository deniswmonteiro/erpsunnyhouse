window.editAddAddress = function (el) {
            ...
            <div class="accordion-item" id="address-${generator.toString()}" data-address-item>
                <h2 class="accordion-header d-flex" id="address-heading-${generator.toString()}">
                    <button type="button" class="accordion-button fw-bold rounded-0 rounded-start" 
                        ...
                        data-bs-target="#address-collapse-${generator.toString()}" aria-expanded="true"
                        aria-controls="address-collapse-${generator.toString()}">
                ...
                <div id="address-collapse-${generator.toString()}" class="accordion-collapse collapse show" 
                    ...
                    <div class="row mt-3">
                            ...
                            <div class="col-12 col-md-4 mb-4">
                                <div class="form-group">
                                    <label for="project-type-${generator.toString()}"
                                        class="form-label">
                                        Tipo de Projeto
                                    </label>
                            ...
                            <div class="col-12 mb-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" 
                                        for="chk-add-generator-client-${generator.toString()}">
                            ...
                            <div class="col-12 col-md-6 mb-4">
                                <div class="form-group">
                                    <div class="form-check form-switch">
                                        ...
                                        <label class="form-check-label fw-normal" style="color: #607080"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 mb-3">
                                <div class="form-group">
                                    <label for="project-generator-power-${generator.toString()}" class="form-label">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3 mb-3 d-none">
                                <div class="form-group">
                                    ...
                                    <div class="invalid-feedback" 
                                        id="generator-consumption-${generator.toString()}-feedback-project"></div>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-6 mb-3 d-none" 
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text"
                                                                id="project-beneficiary-client-${generator.toString()}-1" 
                                                                name="project[generator-${generator.toString()}][beneficiaries][address-1][beneficiary-client]"
                                                                onfocus="return window.autocomplete(this, clients)">
                                                            <div class="invalid-feedback"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input class="form-control" type="text"
                                                                ...
                                                                onchange="return window.handleBeneficiaryRate(this), window.validateInput(this, 1), window.validateInput(this, 1), window.validateBeneficiaryRate(this), window.enableBtnAddBeneficiary(this)"
                                                                onblur="return window.handleBeneficiaryRate(this), window.validateInput(this, 1), window.validateInput(this, 1), window.validateBeneficiaryRate(this)"
                                                                onkeyup="return window.handleBeneficiaryRate(this), window.validateInput(this, 1), window.validateInput(this, 1), window.validateBeneficiaryRate(this)"
                                                                data-beneficiary>
                                                            <span class="input-group-text rounded-end">%</span>
                                                            <span class="input-group-text bg-secondary text-white ms-4 rounded" id="rate-monthly-avg-generation-${generator.toString()}-1"></span>
                                                        </div>
                                                        <div class="invalid-feedback" 
            ...
            <tr>
                ...
                <td class="text-center d-flex justify-content-center pt-4">
                    <a href="${equipment.url}" target="_blank"
                        class="btn bg-primary text-white mt-1 ${hasDatasheet}">
    ...
    // Mask
    $(`#project-cep-${generator.toString()}-1`).mask("00000-000");
    $(`#project-cc-generator-input-${generator.toString()}-1`).mask("0#");
    $(`#project-other-cc-generator-${generator.toString()}`).mask("0#");
    $(`#project-generator-consumption-${generator.toString()}-1`).mask("#####9V##", {
        translation: {
            "V": {
                pattern: /[\,]/
            },
