...
$(document).ready(function () {
    // Mask
    $("#edit-request-second-clientrg").mask("0#");
    $(["#edit-request-second-clientcellphone", "#edit-request-second-clientphone"]).mask(window.SPMaskBehavior, spOptions);
    $(["#edit-request-second-ucpower", "#edit-request-second-ucload", "#edit-request-second-ucbreaker", "#edit-request-second-ucpd", "#edit-request-second-coordinatesx", "#edit-request-second-coordinatesy", "#edit-request-second-generationpower"]).mask("#######9V##", {
        translation: {
            "V": {
                pattern: /[\,]/
            },
...
window.getEngineerData = async function (el) {
    const title = document.querySelector("#edit-request-second-managertitle");
    const registration = document.querySelector("#edit-request-second-managerregistration");
    const registrationState = document.querySelector("#edit-request-second-managerregistrationstate");
    const email = document.querySelector("#edit-request-second-manageremail");
    const phone = document.querySelector("#edit-request-second-managerphone");
    const cellphone = document.querySelector("#edit-request-second-managercellphone");
    const cep = document.querySelector("#edit-request-second-managercep");
    const address = document.querySelector("#edit-request-second-manageraddress");
    const number = document.querySelector("#edit-request-second-managernumber");
    const neighborhood = document.querySelector("#edit-request-second-managerneighborhood");
    const city = document.querySelector("#edit-request-second-managercity");
    const state = document.querySelector("#edit-request-second-managerstate");
...
window.validateRGShippingDate = function (el) {
    const dateFeedback = document.querySelector("#edit-second-clientrgshipping-feedback-request");
    const min = 8;
    const year = 2000;
...
window.validatePhone = function (el, digits = 10) {
    ...
    let phoneFeedback = document.querySelector(`#edit-second-${elemId}-feedback-request`);
...
window.validateDouble = function (el) {
    const elemId = el.id.split("-")[3];
    const feedback = document.querySelector(`#edit-second-${elemId}-feedback-request`);
...
window.submitFormEditRequestTypeSecond = async function () {
    let submit;
    const formEditRequestTypeSecond = document.querySelector("#form-edit-request-type-second");
    const clientRG = document.querySelector("#edit-request-second-clientrg");
    const clientRGShippingDate = document.querySelector("#edit-request-second-clientrgshipping");
    const clientCellphone = document.querySelector("#edit-request-second-clientcellphone");
    const clientPhone = document.querySelector("#edit-request-second-clientphone");
    const branchOfActivity = document.querySelector("#edit-request-second-activity");
    const specialLoads = document.querySelector("#edit-request-second-loads");
    const specialLoadsDetails = document.querySelector("#edit-request-second-loadsdetails");
    const subgroup = document.querySelector("#edit-request-second-subgroup");
    const consumptionClass = document.querySelector("#edit-request-second-class");
    const connType = document.querySelector("#edit-request-second-conntype");
    const ucPower = document.querySelector("#edit-request-second-ucpower");
    const ucLoad = document.querySelector("#edit-request-second-ucload");
    const ucBreaker = document.querySelector("#edit-request-second-ucbreaker");
    const ucPD = document.querySelector("#edit-request-second-ucpd");
    const extensionType = document.querySelector("#edit-request-second-extension");
    const transformerId = document.querySelector("#edit-request-second-transformerid");
    const coordinateX = document.querySelector("#edit-request-second-coordinatesx");
    const coordinateY = document.querySelector("#edit-request-second-coordinatesy");
    const managerName = document.querySelector("#edit-request-second-managername");
    const generationType = document.querySelector("#edit-request-second-generationtype");
    const generationDetails = document.querySelector("#edit-request-second-generationdetails");
    const generationFramework = document.querySelector("#edit-request-second-generationframework");
    const generationPower = document.querySelector("#edit-request-second-generationpower");
    const generationOK = document.querySelector("#edit-request-second-generationok");
    const generationVoltage = document.querySelector("#edit-request-second-generationvoltage");
    const art = document.querySelector("#edit-request-second-art");
    const diagram = document.querySelector("#edit-request-second-diagram");
    const memo = document.querySelector("#edit-request-second-memo");
    const electrical = document.querySelector("#edit-request-second-electrical");
    const compliance = document.querySelector("#edit-request-second-compliance");
    const participants = document.querySelector("#edit-request-second-participants");
    const instrument = document.querySelector("#edit-request-second-instrument");
    const aneel = document.querySelector("#edit-request-second-aneel");
    const link = document.querySelector("#edit-request-second-link");
    const pattern = document.querySelector("#edit-request-second-pattern");
    const rent = document.querySelector("#edit-request-second-rent");
    const procuration = document.querySelector("#edit-request-second-procuration");
    const condominium = document.querySelector("#edit-request-second-condominium");
    ...
    if (submit) formEditRequestTypeSecond.submit();
}