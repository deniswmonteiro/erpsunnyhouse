...
$(document).ready(function () {
    // Mask
    $("#create-request-first-clientrg").mask("0#");
    $(["#create-request-first-clientcellphone", "#create-request-first-clientphone", "#create-request-first-responsiblephone"]).mask(window.SPMaskBehavior, spOptions);
    $(["#create-request-first-ucpower", "#create-request-first-ucload", "#create-request-first-ucbreaker", "#create-request-first-ucpd", "#create-request-first-coordinatesx", "#create-request-first-coordinatesy", "#create-request-first-generationpower"]).mask("########9V##", {
        translation: {
            "V": {
                pattern: /[\,]/
            },
...
window.getEngineerData = async function (el) {
    const title = document.querySelector("#create-request-first-managertitle");
    const registration = document.querySelector("#create-request-first-managerregistration");
    const registrationState = document.querySelector("#create-request-first-managerregistrationstate");
    const email = document.querySelector("#create-request-first-manageremail");
    const phone = document.querySelector("#create-request-first-managerphone");
    const cellphone = document.querySelector("#create-request-first-managercellphone");
    const cep = document.querySelector("#create-request-first-managercep");
    const address = document.querySelector("#create-request-first-manageraddress");
    const number = document.querySelector("#create-request-first-managernumber");
    const neighborhood = document.querySelector("#create-request-first-managerneighborhood");
    const city = document.querySelector("#create-request-first-managercity");
    const state = document.querySelector("#create-request-first-managerstate");
...
window.validateRGShippingDate = function (el) {
    const dateFeedback = document.querySelector("#create-first-clientrgshipping-feedback-request");
    const min = 8;
    const year = 2000;
...
window.validatePhone = function (el, digits = 10) {
    ...
    let phoneFeedback = document.querySelector(`#create-first-${elemId}-feedback-request`);
...
window.validateDouble = function (el) {
    const elemId = el.id.split("-")[3];
    const feedback = document.querySelector(`#create-first-${elemId}-feedback-request`);
...
window.validateResponsibleEmail = function (el) {
    const emailFeedback = document.querySelector("#create-first-responsibleemail-feedback-request");
...
window.submitFormCreateRequestTypeFirst = async function () {
    let submit;
    const formCreateRequestTypeFirst = document.querySelector("#form-create-request-type-first");
    const clientRG = document.querySelector("#create-request-first-clientrg");
    const clientRGShippingDate = document.querySelector("#create-request-first-clientrgshipping");
    const clientCellphone = document.querySelector("#create-request-first-clientcellphone");
    const clientPhone = document.querySelector("#create-request-first-clientphone");
    const branchOfActivity = document.querySelector("#create-request-first-activity");
    const specialLoads = document.querySelector("#create-request-first-loads");
    const specialLoadsDetails = document.querySelector("#create-request-first-loadsdetails");
    const subgroup = document.querySelector("#create-request-first-subgroup");
    const consumptionClass = document.querySelector("#create-request-first-class");
    const connType = document.querySelector("#create-request-first-conntype");
    const ucPower = document.querySelector("#create-request-first-ucpower");
    const ucLoad = document.querySelector("#create-request-first-ucload");
    const ucBreaker = document.querySelector("#create-request-first-ucbreaker");
    const ucPD = document.querySelector("#create-request-first-ucpd");
    const extensionType = document.querySelector("#create-request-first-extension");
    const transformerId = document.querySelector("#create-request-first-transformerid");
    const coordinateX = document.querySelector("#create-request-first-coordinatesx");
    const coordinateY = document.querySelector("#create-request-first-coordinatesy");
    const responsibleName = document.querySelector("#create-request-first-responsiblename");
    const responsiblePhone = document.querySelector("#create-request-first-responsiblephone");
    const responsibleEmail = document.querySelector("#create-request-first-responsibleemail");
    const managerName = document.querySelector("#create-request-first-managername");
    const generationType = document.querySelector("#create-request-first-generationtype");
    const generationDetails = document.querySelector("#create-request-first-generationdetails");
    const generationFramework = document.querySelector("#create-request-first-generationframework");
    const generationPower = document.querySelector("#create-request-first-generationpower");
    const generationOK = document.querySelector("#create-request-first-generationok");
    const generationVoltage = document.querySelector("#create-request-first-generationvoltage");
    const art = document.querySelector("#create-request-first-art");
    const diagram = document.querySelector("#create-request-first-diagram");
    const memo = document.querySelector("#create-request-first-memo");
    const compliance = document.querySelector("#create-request-first-compliance");
    const participants = document.querySelector("#create-request-first-participants");
    const instrument = document.querySelector("#create-request-first-instrument");
    const aneel = document.querySelector("#create-request-first-aneel");
    const link = document.querySelector("#create-request-first-link");
    const pattern = document.querySelector("#create-request-first-pattern");
    const rent = document.querySelector("#create-request-first-rent");
    const procuration = document.querySelector("#create-request-first-procuration");
    const condominium = document.querySelector("#create-request-first-condominium");
    ...
    if (submit) formCreateRequestTypeFirst.submit();
}