...
$(document).ready(function () {
    // Mask
    $("#create-request-third-clientrg").mask("0#");
    $(["#create-request-third-clientcellphone",
        "#create-request-third-clientphone"
    ...
    $(["#create-request-third-ucinstalledloadkw",
        ...
        "#create-request-third-ucpower",
        "#create-request-third-contracteddemandfp",
        "#create-request-third-contracteddemandp",
        "#create-request-third-coordinatesx",
        "#create-request-third-coordinatesy",
        "#create-request-third-generationpower",
...
window.getEngineerData = async function (el) {
    const title = document.querySelector("#create-request-third-managertitle");
    const registration = document.querySelector("#create-request-third-managerregistration");
    const registrationState = document.querySelector("#create-request-third-managerregistrationstate");
    const email = document.querySelector("#create-request-third-manageremail");
    const phone = document.querySelector("#create-request-third-managerphone");
    const cellphone = document.querySelector("#create-request-third-managercellphone");
    const cep = document.querySelector("#create-request-third-managercep");
    const address = document.querySelector("#create-request-third-manageraddress");
    const number = document.querySelector("#create-request-third-managernumber");
    const neighborhood = document.querySelector("#create-request-third-managerneighborhood");
    const city = document.querySelector("#create-request-third-managercity");
    const state = document.querySelector("#create-request-third-managerstate");
...
window.validateRGShippingDate = function (el) {
    const dateFeedback = document.querySelector("#create-third-clientrgshipping-feedback-request");
    const min = 8;
    const year = 2000;
...
window.validatePhone = function (el, digits = 10) {
    ...
    let phoneFeedback = document.querySelector(`#create-third-${elemId}-feedback-request`);
...
window.validateDouble = function (el) {
    const elemId = el.id.split("-")[3];
    const feedback = document.querySelector(`#create-third-${elemId}-feedback-request`);
...
window.submitFormCreateRequestTypeThird = async function () {
    let submit;
    const formCreateRequestTypeThird = document.querySelector("#form-create-request-type-third");
    const clientRG = document.querySelector("#create-request-third-clientrg");
    const clientRGShippingDate = document.querySelector("#create-request-third-clientrgshipping");
    const clientCellphone = document.querySelector("#create-request-third-clientcellphone");
    const clientPhone = document.querySelector("#create-request-third-clientphone");
    const branchOfActivity = document.querySelector("#create-request-third-activity");
    const specialLoads = document.querySelector("#create-request-third-loads");
    const specialLoadsDetails = document.querySelector("#create-request-third-loadsdetails");
    const subgroup = document.querySelector("#create-request-third-subgroup");
    const consumptionClass = document.querySelector("#create-request-third-class");
    const connType = document.querySelector("#create-request-third-conntype");
    const ucConn = document.querySelector("#create-request-third-ucconn");
    const ucInstalledLoadKw = document.querySelector("#create-request-third-ucinstalledloadkw");
    const ucInstalledLoadKva = document.querySelector("#create-request-third-ucinstalledloadkva");
    const ucDemandKw = document.querySelector("#create-request-third-ucdemandkw");
    const ucDemandKva = document.querySelector("#create-request-third-ucdemandkva");
    const ucInputPattern = document.querySelector("#create-request-third-ucinputpattern");
    const ucPower = document.querySelector("#create-request-third-ucpower");
    const tariffGroup = document.querySelector("#create-request-third-tariffgroup");
    const contractedDemandFP = document.querySelector("#create-request-third-contracteddemandfp");
    const contractedDemandP = document.querySelector("#create-request-third-contracteddemandp");
    const extensionType = document.querySelector("#create-request-third-extension");
    const transformerId = document.querySelector("#create-request-third-transformerid");
    const coordinateX = document.querySelector("#create-request-third-coordinatesx");
    const coordinateY = document.querySelector("#create-request-third-coordinatesy");
    const managerName = document.querySelector("#create-request-third-managername");
    const generationType = document.querySelector("#create-request-third-generationtype");
    const generationDetails = document.querySelector("#create-request-third-generationdetails");
    const generationFramework = document.querySelector("#create-request-third-generationframework");
    const generationPower = document.querySelector("#create-request-third-generationpower");
    const generationOK = document.querySelector("#create-request-third-generationok");
    const generationPD = document.querySelector("#create-request-third-generationpd");
    const generationVoltage = document.querySelector("#create-request-third-generationvoltage");
    const art = document.querySelector("#create-request-third-art");
    const diagram = document.querySelector("#create-request-third-diagram");
    const memo = document.querySelector("#create-request-third-memo");
    const electrical = document.querySelector("#create-request-third-electrical");
    const stage = document.querySelector("#create-request-third-stage");
    const compliance = document.querySelector("#create-request-third-compliance");
    const participants = document.querySelector("#create-request-third-participants");
    const instrument = document.querySelector("#create-request-third-instrument");
    const aneel = document.querySelector("#create-request-third-aneel");
    const viability = document.querySelector("#create-request-third-viability");
    const substationAir = document.querySelector("#create-request-third-chartair");
    const substationSheltered = document.querySelector("#create-request-third-chartsheltered");
    const rent = document.querySelector("#create-request-third-rent");
    const procuration = document.querySelector("#create-request-third-procuration");
    const condominium = document.querySelector("#create-request-third-condominium");
    ...
    if (submit) formCreateRequestTypeThird.submit();
}