...
function eventsHandler() {
    ...
    var doneTypingInterval = 1000;  //time in ms, 0.5 second
    ...
    // $('#address').on('change paste keyup input create focus', function (e) {
    //
    ...
    // });
    //
    // $('#number').on('change paste keyup input create focus', function (e) {
    //
...
window.submit_form_seller_create = function () {
    let submit = true;
