...
class PaymentSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($banks as $bank) {
            $code = $bank['value'];
            $name = $bank['name'];
            Bank::create(['name' => $name, 'code' => $code]);
        }

        // Type
        PaymentType::create(['name' => ContractController::$PAYMENT_CASH]);
        PaymentType::create(['name' => ContractController::$PAYMENT_PARTIAL_PARCELED]);
        PaymentType::create(['name' => ContractController::$PAYMENT_TOTAL_PARCELED]);
        PaymentType::create(['name' => ContractController::$PAYMENT_COMPANY_INSTALLMENT]);
        PaymentType::create(['name' => ContractController::$PAYMENT_CUSTOM]);

        // Payment after by
        PaymentAfterBy::create(['name' => ContractController::$PAYMENT_AFTER_SIGNATURE]);
        PaymentAfterBy::create(['name' => ContractController::$PAYMENT_AFTER_CONCLUSION]);
        PaymentAfterBy::create(['name' => ContractController::$PAYMENT_AFTER_HOMOLOGATION]);
    }
}
