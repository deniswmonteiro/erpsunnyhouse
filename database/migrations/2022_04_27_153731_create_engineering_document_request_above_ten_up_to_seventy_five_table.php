...
class CreateEngineeringDocumentRequestAboveTenUpToSeventyFiveTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('engineering_document_request_above_ten_up_to_seventy_five', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('engineering_document_request_above_ten_up_to_seventy_five');
    }
}
