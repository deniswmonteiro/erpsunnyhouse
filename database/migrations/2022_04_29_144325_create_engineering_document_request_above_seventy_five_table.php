...
class CreateEngineeringDocumentRequestAboveSeventyFiveTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('engineering_document_request_above_seventy_five', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('average_fp')->nullable();
            $table->double('uc_installed_load_kw')->nullable();
            $table->double('uc_installed_load_kva')->nullable();
            $table->double('uc_demand_kw')->nullable();
            $table->double('uc_demand_kva')->nullable();
            $table->string('uc_input_pattern');
            $table->double('uc_power')->nullable();
            $table->string('tariff_group');
            $table->double('contracted_demand_fp')->nullable();
            $table->double('contracted_demand_p')->nullable();
            ...
            $table->double('generation_available_power')->nullable();
            ...
            $table->string('electrical_observation')->nullable();
            $table->string('current_stage_observation')->nullable();
            ...
            $table->string('technical_viability_observation')->nullable();
            $table->string('air_substation_observation')->nullable();
            $table->string('air_sheltered_observation')->nullable();
    ...
    {
        Schema::dropIfExists('engineering_document_request_above_seventy_five');
    }
}
